 ...
 * @author Luciano Ces
 */
public class Helper_numeroTexto {
    ...
    public Helper_numeroTexto() {
        numero = 0;
        flag = 0;
    }

    public Helper_numeroTexto(int n) {
        numero = n;
        flag = 0;
    }

    public String convertirLetras(String numero, boolean Mayusculas,String moneda) {
...
//si el numero no tiene parte decimal, se le agrega ,00
        ...
        if (Mayusculas) {
            return num_letras.toUpperCase() + " CON " + parte_decimal + "/100 "+ moneda.toUpperCase();
        } else {
            return num_letras + " con " + parte_decimal + "/100 "+ moneda.toUpperCase();
        }
